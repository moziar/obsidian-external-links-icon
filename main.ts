...
const DEFAULT_SETTINGS: ExternalLinksIconSettings = {
	icons: {
		"goodlinks": {
			"name": "goodlinks",
			"svgData": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"100%\" height=\"100%\" viewBox=\"0 0 29 29\" fill-rule=\"evenodd\" stroke-linejoin=\"round\" stroke-miterlimit=\"2\" xmlns:v=\"https://vecta.io/nano\"><path d=\"M24.04 1.851H4.957c-.805 0-1.457.651-1.457 1.453v22.39c0 .492.25.953.662 1.22s.936.309 1.387.11l8.358-3.703a1.46 1.46 0 0 1 1.186 0l8.357 3.703c.451.199.973.159 1.387-.11s.663-.728.662-1.221V3.304a1.45 1.45 0 0 0-.428-1.029 1.46 1.46 0 0 0-1.032-.424h.001zm-2.18 9.634l-3.086 3.009c-.126.123-.183.299-.153.473l.728 4.248c.033.201-.05.402-.214.521s-.38.135-.561.042l-3.816-2.007a.54.54 0 0 0-.497 0l-3.816 2.007c-.18.093-.397.077-.561-.042s-.246-.32-.213-.521l.728-4.248c.03-.172-.027-.35-.153-.473l-3.088-3.009c-.145-.142-.196-.353-.134-.546a.54.54 0 0 1 .428-.364l4.266-.619c.174-.026.325-.135.402-.292l1.908-3.866c.091-.181.276-.294.478-.294s.387.113.477.294l1.907 3.866c.078.157.228.266.402.292l4.266.62c.2.03.366.171.429.363s.012.404-.132.547l.005-.001z\" fill=\"#ff2456\" fill-rule=\"nonzero\"/></svg>",
			"order": 0,
			"linkType": "scheme"
		},
		"zotero": {
			"name": "zotero",
			"svgData": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"100%\" height=\"100%\" viewBox=\"0 0 93 93\" fill-rule=\"evenodd\" stroke-linejoin=\"round\" stroke-miterlimit=\"2\" xmlns:v=\"https://vecta.io/nano\"><path d=\"M80.732 11.129L28.625 79.59h54.008V91H10.367v-9.128l52.109-68.465H13.032V2h67.7v9.129z\" fill=\"#e9434c\" fill-rule=\"nonzero\"/></svg>",
			"order": 1,
			"linkType": "scheme"
		},
		"snippetslab": {

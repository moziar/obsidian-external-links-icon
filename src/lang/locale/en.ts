export default {
	...
	'Enable internal links or external vault links icon. Only note files are matched.': 'Enable internal links ([[note]]) or external vault links (obsidian://vault) icon. Only notes and canvas files are matched; links to images or other attachments are ignored.',
